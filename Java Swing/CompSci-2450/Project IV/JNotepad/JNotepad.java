...
//
// Description:
// This program is a very basic Notepad text editor. 
...
File fileRef;  
// Initialize my JFileChooser w/ name for easy use
...
// Implimentation of my JFileFilter
...
// Implimentation for saving a file
...
// Implimentation for new save of file
...
// Implimentation of opening a file
...
// Implimentation of overwriting a file
...
// Implimentation for new file save 
void newFile()  
{  
if(!confirmSave()) return;  
...
public class JNotepad  implements ActionListener, MenuConstants  
{  
...
String applicationName="(c) Rene B. Dena, 2018";  
  
String searchString, replaceString;  
int lastSearchIndex;  
  
FileOperation fileHandler;  
JFontChooser fontDialog=null;  
MyDialogs findReplaceDialog=null;   
...
// Implimentation of ActionListeners
ta.addCaretListener(  
new CaretListener()  
{  
...
{  
if(JNotepad.this.ta.getText().length()==0)  
    return;  
if(findReplaceDialog==null)  
    findReplaceDialog=new MyDialogs(JNotepad.this.ta);  
findReplaceDialog.showDialog(JNotepad.this.f,true);
}  
...
if(findReplaceDialog==null)  
    findReplaceDialog=new MyDialogs(JNotepad.this.ta);  
findReplaceDialog.showDialog(JNotepad.this.f,false);
}    
...
{  
if(fontDialog==null)  
    fontDialog=new JFontChooser(ta.getFont());  
  
if(fontDialog.showDialog(JNotepad.this.f,"Choose a font"))  
    JNotepad.this.ta.setFont(fontDialog.createFont());  
}  
...
{  
JOptionPane.showMessageDialog(JNotepad.this.f,aboutText,"About Menu",  
JOptionPane.INFORMATION_MESSAGE);  
}  
else  
...
// Implimentation for color of background
...
if(backgroundDialog==null)  
    backgroundDialog=JColorChooser.createDialog  
        ...
        {public void actionPerformed(ActionEvent evvv){  
            JNotepad.this.ta.setBackground(bcolorChooser.getColor());}},  
        null);        
  
backgroundDialog.setVisible(true);  
}  

// Implimentation for color of forground  
...
if(foregroundDialog==null)  
    foregroundDialog=JColorChooser.createDialog  
        ...
        new ActionListener()  
        {public void actionPerformed(ActionEvent evvv){  
            JNotepad.this.ta.setForeground(fcolorChooser.getColor());}},  
        null);        
...
//Implimentation of selected item in menu
...
//Implimentation for Look and Feel  
...
{  
   public void menuSelected(MenuEvent evvvv)  
    ...
    if(JNotepad.this.ta.getSelectionStart()==ta.getSelectionEnd())  
    {  
...
final String formatForeground="Set Forground Color...";  
final String formatBackground="Set Background Color...";  
  
final String viewStatusBar="Status Bar";  
  
final String helpHelpTopic="View Help";  
final String helpAboutNotepad="About JNotepad";  
  
final String aboutText="(c) Rene B. Dena, 2018";  
}  
